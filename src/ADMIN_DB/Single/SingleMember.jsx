  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setProfile(userinfo.data[0]);

        let response;
        if (selectedTime === "new") {
          response = await useAxios.get(
            `/posts/neworder/${userinfo.data[0].uid}`
          );
        } else if (selectedTime === "old") {
          response = await useAxios.get(`/posts/user/${userinfo.data[0].uid}`);
        } else {
          response = await useAxios.get(`/posts/user/${userinfo.data[0].uid}`);
        }
  ...
  return (
    <div className="p-4 sm:ml-64">
      <div className="flex justify-center items-center">
        <h1 className="font-medium mr-1">รายการทั้งหมดของ </h1>
        <h2 className="font-bold text-customBlue">
          {" "}
          {profile.usercode} {profile.fname} {profile.lname}
        </h2>
      </div>
            ...
            {currentItems.slice(0, 100).map((item, index) => (
              ...
              >
                ...
                <td className="px-6 py-4">
                  ...
                  <Link
                    to={`/admin/incidence/edit/${item.pid}`}
        ...
        >
          <div className="bg-white p-4 rounded-lg shadow-lg w-100 max-w-100">
            ...
            <div className="mt-2 flex mb-3">
              ...
              <div id="DetailPost" className="ml-4 mr-10">
                ...
                <div className="mt-1 flex items-center">
                  <p className="mr-2 font-bold text-l text-black">
                    หมวดหมู่ :{" "}
                  </p>
                ...
                <div className="mt-1">
                  ...
                  <p className="text-customGrays text-left mr-10">
                    {selectedItem.detail}
                  </p>
                </div>
                <div className="flex flex-col">
                  <div className="flex items-center mt-1">
                    ...
                    <p className="ml-1 text-customGrays">
                  ...
                  <div className="flex items-center mt-1">
                    ...
                    <p className="ml-2 font-bold">
                      {selectedItem.Date}
                      {" • " +
                        moment(selectedItem.time, "HH:mm").format("HH:mm") +
                        " น."}
                    </p>
                    <br />
                  </div>
            ...
            <div className="float-right">
              <button
                onClick={() => {
                  window.location.href = `/admin/incidence/edit/${selectedItem.pid}`;
                }}
                className="text-white mr-1 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                type="button"
              >
                แก้ไข
              </button>
