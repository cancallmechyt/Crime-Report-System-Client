...
function CollegeChart() {
  ...
  const renderCustomizedLabel = ({ x, y, value }) => {
    return (
      <text x={x} y={y} fill="#000" textAnchor="middle" dy={5}>
        {value}
      </text>
    );
  };
  ...
  return (
    <div style={{ display: "flex" }}>
      ...
      <div>
        <p className="ml-4 flex items-center justify-center text-2xl font-bold">
          จำนวนสมาชิกของแต่ละคณะ
        </p>
