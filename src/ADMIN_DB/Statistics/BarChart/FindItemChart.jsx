    ...
    const fetchData = async () => {
        try {
            const responses = await Promise.all([
                ...
                const response = await useAxios.get(`/chartbar/incidence/catebylocation/${location}/ตามหาของ`);
...
const data = [
  ...
  return (
    ...
    <h1 className="text-l text-center font-bold ">สถิติสถานที่หมวดหมู่ตามหาเจ้าของ</h1>
    <div className="chart">
