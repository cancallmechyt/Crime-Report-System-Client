  ...
  return (
    <div className="p-4 sm:ml-64">
      ...
      <div className='flex justify-center items-center'>
        <h1 className='text-xl font-medium text-gray-900 font-bold mr-1 mb-2'>แสดงสมาชิกทั้งหมดภายในระบบ </h1>
      </div>
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <div className="flex justify-between">
          <div className="ml-2 mt-3">
            <select id="dropdownRadioButton" className="text-gray-500 bg-white border border-gray-300 focus:outline-none focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm py-1.5 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:focus:ring-gray-700" onChange={handleSelectChange}>
        ...
        <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
          <tr>
            ...
            <th scope="col" className="px-6 py-3">คณะ/วิทยาลัย</th>
            <th scope="col" className="px-6 py-3">สาขาวิชา</th>
          ...
          <tbody>
            {currentItems.slice(0, 100).map((item, index) => (
              <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{item.usercode}</th>
                ...
                <td className="px-6 py-4"> 
                  <Link to={`/admin/single/member/${item.uid}`} className="font-medium text-green-600 dark:text-blue-500 hover:underline mr-2">View</Link>
                  <Link to={`/admin/member/edit/${item.uid}`} className="font-medium text-blue-600 dark:text-blue-500 hover:underline mr-2">Edit</Link>
                  <a onClick={() => handleDelete(item)} className="font-medium text-red-600 dark:text-red-500 hover:underline">Delete</a>
                </td>
              </tr>
            ))}
          </tbody>
