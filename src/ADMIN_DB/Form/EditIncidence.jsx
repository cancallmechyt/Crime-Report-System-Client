          ...
          <div id="Detail" className="w-2/3 pl-4">
            ...
            <div className="mb-2">
              ...
              <textarea
                ...
                value={value.detail}
                onChange={(e) =>
                  setValues({ ...value, detail: e.target.value })
                }
              ></textarea>
            </div>
            <div className="grid mt-2 mb-2 gap-6 md:grid-cols-2">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  value={value.note}
                  onChange={(e) =>
                    setValues({ ...value, note: e.target.value })
                  }
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div className="flex items-start mb-2">
              ...
              <label className="mb-2 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
            ...
            <button
              type="submit"
              className="float-right mr-2 text-white bg-customBlue hover:bg-customYellow focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
